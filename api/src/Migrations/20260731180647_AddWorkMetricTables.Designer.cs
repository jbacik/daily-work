...
namespace DailyWork.Api.Migrations
{
    ...
    [Migration("20260731180647_AddWorkMetricTables")]
    partial class AddWorkMetricTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DailyWork.Api.Entities.WorkMetricDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("WorkMetricDefinitions");
                });

            modelBuilder.Entity("DailyWork.Api.Entities.WorkMetricEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("WeekOf", "Title")
                        .IsUnique();

                    b.ToTable("WorkMetricEntries");
                });
            ...
            modelBuilder.Entity("DailyWork.Api.Entities.WorkMetricEntry", b =>
                {
                    b.HasOne("DailyWork.Api.Entities.WorkMetricDefinition", null)
                        .WithMany()
